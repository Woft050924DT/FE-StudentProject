  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Quản lý và cập nhật thông tin cá nhân</p>
      </div>
              ...
              <div className="flex gap-2">
                ...
                {studentData.cvFile && (
                  <span className="px-3 py-2 bg-gray-100 text-gray-700 rounded-md text-sm">
                    {typeof studentData.cvFile === "string"
                      ? studentData.cvFile
                      : studentData.cvFile.name}
                  </span>
                )}
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("gender", e.target.value as "Nam" | "Nữ")
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
